  ...
  <View style={[styles.gameCard, { backgroundColor: theme.colors.card, shadowColor: theme.colors.cardShadow }]}>
    <View style={styles.gameCardRow}>
      ...
      <View style={styles.gameInfo}>
        ...
        <Text style={[styles.predictionCount, { color: theme.colors.textSecondary }]} numberOfLines={1}>
          {item.adminPredictions ? item.adminPredictions.length : 0} predictions configured
        </Text>
      </View>
            ...
            <FlatList
              ...
              ListHeaderComponent={() => (
                <>
                  ...
                  <Text style={[styles.modalSubtitleGame, { color: theme.colors.primary }]}>
                    {selectedGame?.title}
                  </Text>
              ...
              renderItem={({ item, index }) => (
                <View style={styles.predictionInputContainer}>
                  <View style={[styles.indexBadge, { backgroundColor: 'rgba(0, 122, 255, 0.15)' }]}>
                    <Text style={[styles.indexBadgeText, { color: theme.colors.primary }]}>{index + 1}</Text>
                  </View>
                  <TextInput
