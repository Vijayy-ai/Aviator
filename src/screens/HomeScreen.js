...
// Debug import
console.log('🔍 HomeScreen - ADMIN_EMAIL imported:', ADMIN_EMAIL);
console.log('🔍 HomeScreen - typeof ADMIN_EMAIL:', typeof ADMIN_EMAIL);
...
export default function HomeScreen({ navigation }) {
  ...
  console.log('   - Is admin:', auth.currentUser?.email === ADMIN_EMAIL);
  ...
  const fetchGames = async () => {
    try {
      ...
      // Sort pinned games to the top manually
