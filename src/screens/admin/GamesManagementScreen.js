  ...
  const fixOldImageUrl = async (gameId, oldUrl) => {
    try {
      ...
      if (cleanUrl !== oldUrl) {
        ...
        console.log('✅ URL fixed in database');
    ...
    <View style={[
      ...
      <Image 
        ...
        onError={async (error) => {
          ...
          // If image fails to load, try to fix old URL
      ...
      <View style={styles.gameActions}>
        ...
        >
          <Ionicons
            ...
            size={20}
            color={item.isPinned ? theme.colors.warning : theme.colors.textSecondary}
          />
        </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          ...
          />
            ...
            <TextInput
              ...
              placeholder="Game Website Link (e.g., https://example.com)"
              placeholderTextColor={theme.colors.textSecondary}
...
const styles = StyleSheet.create({
  ...
  gamesList: {
    padding: 16,
    paddingBottom: 48, // 👈 niche se extra space taki last game sahi se dikhe
  },
  gameCard: {
    borderRadius: 12,
    marginBottom: 16,
